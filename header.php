...
<head>
  ...
  <title>Taste Restaurant - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
        <div class="sidebar-brand-text mx-3">Taste Restaurant</div>
      </a>
...
<li class="nav-item">
  ...
  <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <a class="collapse-item" href="employees.php">
        <i class="fas fa-fw fa-table"></i>
        <span>Employees</span>
      </a>
      <a class="collapse-item" href="schedule.php">
        <i class="fas fa-fw fa-table"></i>
        <span>Schedules</span>
      </a>
    </div>
...
<li class="nav-item">
  <a class="nav-link" href="reservations.php">
    <i class="fas fa-fw fa-table"></i>
    <span>Reservations Management</span></a>
</li>
...
<li class="nav-item">
  <a class="nav-link" href="current.php">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Current Month Report</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="cost.php">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Costs Report</span></a>
</li>
