<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:104:"D:\systemsoft\phpstudy\phpstudy_pro\WWW\www.fast.com\public/../application/index\view\user\add_case.html";i:1583262927;s:95:"D:\systemsoft\phpstudy\phpstudy_pro\WWW\www.fast.com\application\index\view\layout\default.html";i:1583127433;s:92:"D:\systemsoft\phpstudy\phpstudy_pro\WWW\www.fast.com\application\index\view\common\meta.html";i:1582854760;s:95:"D:\systemsoft\phpstudy\phpstudy_pro\WWW\www.fast.com\application\index\view\common\sidenav.html";i:1583170706;s:94:"D:\systemsoft\phpstudy\phpstudy_pro\WWW\www.fast.com\application\index\view\common\script.html";i:1582854760;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 class="page-header"><?php echo __('Add case'); ?></h2>
                    <form id="changepwd-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
                        <?php echo token(); ?>

                        <div class="form-group">
                            <label for="oldpassword" class="control-label col-xs-12 col-sm-2"><?php echo __('Case name'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="text" class="form-control" id="oldpassword" name="case_name" value="" data-rule="required" placeholder="<?php echo __('Case name'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input name="tag" value="<?php echo __('Criminal case'); ?>" type="radio"><?php echo __('Criminal case'); ?>
                                </label>
                                <label>
                                    <input name="tag" value="<?php echo __('Civil case'); ?>" type="radio"><?php echo __('Civil case'); ?>
                                </label>
                                <label>
                                    <input name="tag" value="<?php echo __('Jurisdiction case'); ?>" type="radio"><?php echo __('Jurisdiction case'); ?>
                                </label>
                                <label>
                                    <input name="tag" value="<?php echo __('administrative case'); ?>" type="radio"><?php echo __('administrative case'); ?>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <textarea  style="height: 200px;width: 600px;" class="form-control" id="content" name="contents"></textarea>
                            </div>
                        </div>
